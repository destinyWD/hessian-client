...
public class SpiExtensionFactory implements ExtensionFactory {
	...
	public static final ConcurrentMap<String, Object> EXTENSION_INSTANCES = new ConcurrentHashMap<String,Object>();

	public static final ConcurrentMap<String, Object> SERVICE_URL = new ConcurrentHashMap<String,Object>();
	
	List<String> ignoreConvertClassNameList = new ArrayList<String>();
	
	public SpiExtensionFactory() {
		ignoreConvertClassNameList.add("wangd");
	}
	...
	public <S extends BaseExecuteResult<?>> S execute(String interfaceAliasName, Object ...args){
		...
		SpiSerivce service = (SpiSerivce) getExtensionInstances(interfaceAliasName);
		if (executionListener != null) {
			ExecutionResult result = executionListener.handleExecution(service, interfaceAliasName, args);
			if(result.handled) {
				S sResult = (S) result.getResult();
				try{
	...
	static {
		...
		String fullName = "META-INF/spi_services/";
		try {
